...
module k0_ZTS9optimized_bb_ZTS9optimized_B0_stall_region (
    ...
    wire [0:0] merged_in_SE_out_i_llvm_fpga_pop_throttle_i1_throttle_pop_k0_zts9optimized0_backStall;
    wire [0:0] merged_in_SE_out_i_llvm_fpga_pop_throttle_i1_throttle_pop_k0_zts9optimized0_V0;
    wire [0:0] merged_in_SE_out_i_llvm_fpga_pop_throttle_i1_throttle_pop_k0_zts9optimized0_V1;
    wire [0:0] merged_in_SE_out_i_llvm_fpga_pop_throttle_i1_throttle_pop_k0_zts9optimized0_V2;
    wire [0:0] merged_in_SE_out_i_llvm_fpga_pop_throttle_i1_throttle_pop_k0_zts9optimized0_temp_back_stall;
    ...
    // i_llvm_fpga_pop_throttle_i1_throttle_pop_k0_zts9optimized0_out_almost_empty_out_reg0(REG,34)
    ...
    // i_llvm_fpga_pop_throttle_i1_throttle_pop_k0_zts9optimized0_out_almost_empty_out_reg1(REG,33)
    always @ (posedge clock)
    begin
        if (0)
        begin
    ...
    // i_llvm_fpga_pop_throttle_i1_throttle_pop_k0_zts9optimized0_out_empty_out_reg0(REG,36)
    always @ (posedge clock)
    begin
        if (0)
        begin
    ...
    // i_llvm_fpga_pop_throttle_i1_throttle_pop_k0_zts9optimized0_out_empty_out_reg1(REG,35)
    always @ (posedge clock)
    begin
        if (0)
        begin
    ...
    // i_llvm_fpga_pop_throttle_i1_throttle_pop_k0_zts9optimized0_out_valid_out_reg0(REG,38)
    always @ (posedge clock)
    begin
        if (0)
        begin
    ...
    // i_llvm_fpga_pop_throttle_i1_throttle_pop_k0_zts9optimized0_out_valid_out_reg1(REG,37)
    always @ (posedge clock)
    begin
        if (0)
        begin
    ...
    // merged_in_SE_out_i_llvm_fpga_pop_throttle_i1_throttle_pop_k0_zts9optimized0(STALLENABLE,30)
    assign merged_in_SE_out_i_llvm_fpga_pop_throttle_i1_throttle_pop_k0_zts9optimized0_backStall = in_stall_in;
    assign merged_in_SE_out_i_llvm_fpga_pop_throttle_i1_throttle_pop_k0_zts9optimized0_V0 = i_llvm_fpga_pop_throttle_i1_throttle_pop_k0_zts9optimized0_out_valid_out_reg1_q;
    assign merged_in_SE_out_i_llvm_fpga_pop_throttle_i1_throttle_pop_k0_zts9optimized0_V1 = i_llvm_fpga_pop_throttle_i1_throttle_pop_k0_zts9optimized0_out_empty_out_reg1_q;
    assign merged_in_SE_out_i_llvm_fpga_pop_throttle_i1_throttle_pop_k0_zts9optimized0_V2 = i_llvm_fpga_pop_throttle_i1_throttle_pop_k0_zts9optimized0_out_almost_empty_out_reg1_q;

    // i_llvm_fpga_pop_throttle_i1_throttle_pop_k0_zts9optimized0_in_stall_in_reg0(REG,31)
    always @ (posedge clock)
    begin
        if (0)
        begin
        ...
        begin
            i_llvm_fpga_pop_throttle_i1_throttle_pop_k0_zts9optimized0_in_stall_in_reg0_q <= $unsigned(merged_in_SE_out_i_llvm_fpga_pop_throttle_i1_throttle_pop_k0_zts9optimized0_backStall);
        end
    end

    // i_llvm_fpga_pop_throttle_i1_throttle_pop_k0_zts9optimized0_in_stall_in_reg1(REG,32)
    always @ (posedge clock)
    begin
        if (0)
        begin
    ...
    assign merged_in_SE_stall_entry_backStall = i_llvm_fpga_pop_throttle_i1_throttle_pop_k0_zts9optimized0_out_stall_out;
    ...
    // i_llvm_fpga_pop_throttle_i1_throttle_pop_k0_zts9optimized0(BLACKBOX,10)@0
    ...
    assign out_feedback_stall_out_0 = i_llvm_fpga_pop_throttle_i1_throttle_pop_k0_zts9optimized0_out_feedback_stall_out_0;
    ...
    assign out_almost_empty_out = merged_in_SE_out_i_llvm_fpga_pop_throttle_i1_throttle_pop_k0_zts9optimized0_V2;
    assign out_empty_out = merged_in_SE_out_i_llvm_fpga_pop_throttle_i1_throttle_pop_k0_zts9optimized0_V1;
    assign out_valid_out = merged_in_SE_out_i_llvm_fpga_pop_throttle_i1_throttle_pop_k0_zts9optimized0_V0;
