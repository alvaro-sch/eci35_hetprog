...
module k0_ZTS9optimized_bb_ZTS9optimized_B1 (
    ...
    wire [0:0] bb_ZTS9optimized_B1_stall_region_out_feedback_almost_empty_out_0;
    wire [0:0] bb_ZTS9optimized_B1_stall_region_out_feedback_data_out_0;
    wire [0:0] bb_ZTS9optimized_B1_stall_region_out_feedback_empty_out_0;
    wire [0:0] bb_ZTS9optimized_B1_stall_region_out_lsu_memdep_o_active;
    wire [34:0] bb_ZTS9optimized_B1_stall_region_out_memdep_k0_ZTS9optimized_avm_address;
    wire [4:0] bb_ZTS9optimized_B1_stall_region_out_memdep_k0_ZTS9optimized_avm_burstcount;
    wire [63:0] bb_ZTS9optimized_B1_stall_region_out_memdep_k0_ZTS9optimized_avm_byteenable;
    wire [0:0] bb_ZTS9optimized_B1_stall_region_out_memdep_k0_ZTS9optimized_avm_enable;
    wire [0:0] bb_ZTS9optimized_B1_stall_region_out_memdep_k0_ZTS9optimized_avm_read;
    wire [0:0] bb_ZTS9optimized_B1_stall_region_out_memdep_k0_ZTS9optimized_avm_write;
    wire [511:0] bb_ZTS9optimized_B1_stall_region_out_memdep_k0_ZTS9optimized_avm_writedata;
    ...
    k0_ZTS9optimized_bb_ZTS9optimized_B1_stall_region thebb_ZTS9optimized_B1_stall_region (
        ...
        .out_feedback_almost_empty_out_0(bb_ZTS9optimized_B1_stall_region_out_feedback_almost_empty_out_0),
        .out_feedback_data_out_0(bb_ZTS9optimized_B1_stall_region_out_feedback_data_out_0),
        .out_feedback_empty_out_0(bb_ZTS9optimized_B1_stall_region_out_feedback_empty_out_0),
        .out_lsu_memdep_o_active(bb_ZTS9optimized_B1_stall_region_out_lsu_memdep_o_active),
        .out_memdep_k0_ZTS9optimized_avm_address(bb_ZTS9optimized_B1_stall_region_out_memdep_k0_ZTS9optimized_avm_address),
        .out_memdep_k0_ZTS9optimized_avm_burstcount(bb_ZTS9optimized_B1_stall_region_out_memdep_k0_ZTS9optimized_avm_burstcount),
        .out_memdep_k0_ZTS9optimized_avm_byteenable(bb_ZTS9optimized_B1_stall_region_out_memdep_k0_ZTS9optimized_avm_byteenable),
        .out_memdep_k0_ZTS9optimized_avm_enable(bb_ZTS9optimized_B1_stall_region_out_memdep_k0_ZTS9optimized_avm_enable),
        .out_memdep_k0_ZTS9optimized_avm_read(bb_ZTS9optimized_B1_stall_region_out_memdep_k0_ZTS9optimized_avm_read),
        .out_memdep_k0_ZTS9optimized_avm_write(bb_ZTS9optimized_B1_stall_region_out_memdep_k0_ZTS9optimized_avm_write),
        .out_memdep_k0_ZTS9optimized_avm_writedata(bb_ZTS9optimized_B1_stall_region_out_memdep_k0_ZTS9optimized_avm_writedata),
    ...
    assign out_feedback_almost_empty_out_0 = bb_ZTS9optimized_B1_stall_region_out_feedback_almost_empty_out_0;

    // feedback_data_out_0_sync(GPOUT,6)
    assign out_feedback_data_out_0 = bb_ZTS9optimized_B1_stall_region_out_feedback_data_out_0;

    // feedback_empty_out_0_sync(GPOUT,7)
    assign out_feedback_empty_out_0 = bb_ZTS9optimized_B1_stall_region_out_feedback_empty_out_0;

    // out_lsu_memdep_o_active(GPOUT,9)
    assign out_lsu_memdep_o_active = bb_ZTS9optimized_B1_stall_region_out_lsu_memdep_o_active;

    // out_memdep_k0_ZTS9optimized_avm_address(GPOUT,10)
    assign out_memdep_k0_ZTS9optimized_avm_address = bb_ZTS9optimized_B1_stall_region_out_memdep_k0_ZTS9optimized_avm_address;

    // out_memdep_k0_ZTS9optimized_avm_burstcount(GPOUT,11)
    assign out_memdep_k0_ZTS9optimized_avm_burstcount = bb_ZTS9optimized_B1_stall_region_out_memdep_k0_ZTS9optimized_avm_burstcount;

    // out_memdep_k0_ZTS9optimized_avm_byteenable(GPOUT,12)
    assign out_memdep_k0_ZTS9optimized_avm_byteenable = bb_ZTS9optimized_B1_stall_region_out_memdep_k0_ZTS9optimized_avm_byteenable;

    // out_memdep_k0_ZTS9optimized_avm_enable(GPOUT,13)
    assign out_memdep_k0_ZTS9optimized_avm_enable = bb_ZTS9optimized_B1_stall_region_out_memdep_k0_ZTS9optimized_avm_enable;

    // out_memdep_k0_ZTS9optimized_avm_read(GPOUT,14)
    assign out_memdep_k0_ZTS9optimized_avm_read = bb_ZTS9optimized_B1_stall_region_out_memdep_k0_ZTS9optimized_avm_read;

    // out_memdep_k0_ZTS9optimized_avm_write(GPOUT,15)
    assign out_memdep_k0_ZTS9optimized_avm_write = bb_ZTS9optimized_B1_stall_region_out_memdep_k0_ZTS9optimized_avm_write;

    // out_memdep_k0_ZTS9optimized_avm_writedata(GPOUT,16)
    assign out_memdep_k0_ZTS9optimized_avm_writedata = bb_ZTS9optimized_B1_stall_region_out_memdep_k0_ZTS9optimized_avm_writedata;
