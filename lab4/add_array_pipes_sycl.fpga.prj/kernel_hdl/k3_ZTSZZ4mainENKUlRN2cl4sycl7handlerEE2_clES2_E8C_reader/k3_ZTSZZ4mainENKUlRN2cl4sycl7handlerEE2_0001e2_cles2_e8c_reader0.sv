...
// SystemVerilog created from i_iord_bl_acl_c_zn2cl4sycl3ext5intel4pipei12c_write_pipefli16ee9m_storagee_pipe_channel_unnamed_k3_ztszz4mainenkulrn2cl4sycl7handleree2_cles2_e8c_reader0_k3_ztszz4mainenkulrn2cl4sycl7handleree2_cles2_e8c_reader0
...
module k3_ZTSZZ4mainENKUlRN2cl4sycl7handlerEE2_0001e2_cles2_e8c_reader0 (
    ...
    // iord(EXTIFACE,5)
    assign iord_i_fifodata = in_iord_bl_acl_c_ZN2cl4sycl3ext5intel4pipeI12c_write_pipefLi16EE9m_StorageE_pipe_channel_i_fifodata;
    ...
    assign iord_i_fifovalid = in_iord_bl_acl_c_ZN2cl4sycl3ext5intel4pipeI12c_write_pipefLi16EE9m_StorageE_pipe_channel_i_fifovalid;
    ...
    hld_iord #(
        ...
        .i_fifodata(in_iord_bl_acl_c_ZN2cl4sycl3ext5intel4pipeI12c_write_pipefLi16EE9m_StorageE_pipe_channel_i_fifodata),
    ...
    assign out_iord_bl_acl_c_ZN2cl4sycl3ext5intel4pipeI12c_write_pipefLi16EE9m_StorageE_pipe_channel_o_fifoalmost_full = iord_o_fifoalmost_full;

    // sync_out(GPOUT,11)@20000000
    assign out_o_stall = iord_o_stall;

    // dupName_0_regfree_osync_x(GPOUT,13)
    assign out_iord_bl_acl_c_ZN2cl4sycl3ext5intel4pipeI12c_write_pipefLi16EE9m_StorageE_pipe_channel_o_fifoready = iord_o_fifoready;
